      ...
      cards: [
        ...
        },
        {
          ...
          words: [
            ...
            { word: "CENTRAL", hint: "… Park" },
            { word: "PARK", hint: "der Park" },
            { word: "EMPIRE", hint: "the … State Building" },
            { word: "TIMES", hint: "… Square" },
            { word: "SQUARE", hint: "der Platz" },
            { word: "PIZZA", hint: "von Joe's Pizza" },
            { word: "PHONE", hint: "das Telefon" },
            { word: "HELLO", hint: "Begrüßung am Telefon" },
            { word: "FRIEND", hint: "der Freund / die Freundin" },
            { word: "FAMILY", hint: "die Familie" },
            { word: "PHOTO", hint: "das Foto" },
            { word: "SUBWAY", hint: "die U-Bahn (AE)" },
            { word: "TOMORROW", hint: "morgen (ein Plan)" },
            { word: "YESTERDAY", hint: "gestern (Simple Past)" },
            { word: "ALREADY", hint: "schon (Present Perfect)" },
