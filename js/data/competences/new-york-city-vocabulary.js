  ...
  wordMaster: {
    courses: [
      ...
      },
      {
        ...
        subtitle: "Read the German sentence, then complete the English one.",
        items: [
          { de: "Nach einer Stunde Warten kam die Langeweile.", en: "After an hour of waiting, ___ set in.", answer: "boredom" },
          { de: "Wir nahmen eine ruhige Sitzecke hinten im Diner.", en: "We took a quiet ___ at the back of the diner.", answer: "booth" },
          { de: "Das Hotel liegt nahe am Times Square.", en: "The hotel is ___ to Times Square.", answer: "close" },
          { de: "Die zwei Jungen hatten eine Schlägerei auf dem Schulhof.", en: "The two boys had a ___ in the schoolyard.", answer: "fight" },
          { de: "Ihr Büro ist im zehnten Stock.", en: "Her office is on the tenth ___.", answer: "floor" },
          { de: "Gib nicht auf – du bist fast da!", en: "Don't ___ — you're almost there!", answer: "give up", accept: ["give-up"] },
          { de: "Ich glaube, wir könnten den späteren Zug nehmen.", en: "___ we could take the later train.", answer: "I guess", accept: ["i guess"] },
          { de: "Er lehnte sein Fahrrad an die Wand.", en: "He ___ his bike against the wall.", answer: "leaned", accept: ["leant", "lean"] },
          { de: "Gute Manieren kommen nie aus der Mode.", en: "Good ___ never go out of style.", answer: "manners" },
          { de: "Der Kellner nahm unsere Bestellung auf.", en: "The waiter took our ___.", answer: "order" },
          { de: "Sie war zu allen im Raum höflich.", en: "She was ___ to everyone in the room.", answer: "polite" },
          { de: "Die Katze starrte mich vom Fensterbrett aus an.", en: "The cat ___ at me from the windowsill.", answer: "stared", accept: ["stare", "stares"] },
          { de: "Sie planten eine Party, um sie zu überraschen.", en: "They planned a party to ___ her.", answer: "surprise" },
          { de: "Ich habe nicht jedes Wort verstanden, aber das Wesentliche habe ich mitbekommen.", en: "I didn't catch every word, but I got the ___.", answer: "gist", accept: ["the gist"] },
