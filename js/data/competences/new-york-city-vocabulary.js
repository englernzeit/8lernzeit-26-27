    ...
    /* ================= STEP 2 — G-Kurs ================= */
    {
      ...
      cards: [
        ...
        },
        {
          ...
          scene: "kitchen",
          promptAccent: "slate",
          introLead: "Your host mum left you this note in English. Your mum is visiting you from Germany and doesn't speak English.",
          introTask: "Explain the four most important points to her in German — you do not need to translate every word.",
          incoming: {
            note: "letter",
            greeting: ["Hi!", "Welcome to New York!", "I hope you enjoy your staying!"],
            body: [
              "P.S. I put 20 dollars on the table. Please, go to the store around the corner and buy tea and some cookies and candy for tonight.",
              "Please be back by 6 p.m.",
            ],
            mark: ["20 dollars", "tea", "cookies and candy", "6 p.m."],
            sign: "Susan",
            heart: "💜",
          },
          prompts: [
        ...
        },
        {
          ...
          promptBox: true,
          promptAccent: "olive",
          introLead: "Your mum gives you her shopping wishes in German. You are in a New York store.",
          introTask: "Tell the shop assistant in English what you are looking for — write three polite sentences.",
          incoming: {
            note: "list",
            heading: "Danke! Hab dich lieb!",
            heart: "💗",
            sign: "Mama",
            items: ["eine Hose in Größe 38", "Turnschuhe für Papa", "frag bitte, ob es die Hose auch in Blau gibt"],
          },
          prompts: [
        ...
        },
        {
          ...
          max: 90,
          chips: [
            { label: "I'm looking for …", icon: "search" },
            { label: "Do you have … in size …?", icon: "size" },
            { label: "Where is the elevator?", icon: "elevator" },
            { label: "How much is it?", icon: "tag" },
            { label: "Can I have the receipt?", icon: "receipt" },
            { label: "the first floor", icon: "floor" },
            { label: "sneakers – pants – candy", icon: "bag" },
          ],
          dialogue: {
            speakers: ["ASSISTANT", "YOU"],
            lines: 10,
            placeholders: ["Hi there! Can I help you?", "Yes, please. I'm looking for …"],
          },
        },
      ],
    },
    ...
    /* ================= STEP 3 — E-Kurs ================= */
    {
      ...
      cards: [
        ...
        },
        {
          ...
          intro: "In New York you hear American English. Tap an American word, then its British partner.",
          leftLabel: "American",
          rightLabel: "British",
          pairs: [
            { left: "cookie", right: "biscuit" },
            { left: "drug store", right: "chemist's" },
            { left: "french fries", right: "chips" },
            { left: "intersection", right: "crossroads" },
            { left: "movie", right: "film" },
            { left: "yard", right: "garden" },
            { left: "first floor", right: "ground floor" },
            { left: "sick", right: "ill" },
