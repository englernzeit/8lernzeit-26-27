    ...
    /* ================= STEP 1 — LE ================= */
    {
      ...
      cards: [
        ...
        },
        {
          ...
          words: [
            { word: "CAPITAL", hint: "die Hauptstadt" },
            { word: "STATE", hint: "der Bundesstaat" },
            { word: "FLAG", hint: "die Flagge" },
            { word: "BOROUGH", hint: "der Stadtbezirk" },
            { word: "FAMOUS", hint: "berühmt" },
            { word: "LANDMARK", hint: "das Wahrzeichen" },
            { word: "POPULATION", hint: "die Einwohnerzahl" },
            { word: "IMMIGRANT", hint: "der/die Einwanderer·in" },
            { word: "LIBERTY", hint: "die Freiheit" },
            { word: "MANHATTAN", hint: "a New York borough" },
            { word: "BROOKLYN", hint: "a New York borough" },
            { word: "QUEENS", hint: "a New York borough" },
            { word: "BRONX", hint: "the … (a borough)" },
            { word: "SUBWAY", hint: "die U-Bahn (AE)" },
            { word: "VACATION", hint: "der Urlaub (AE)" },
            { word: "APARTMENT", hint: "die Wohnung (AE)" },
            { word: "TROUSERS", hint: "die Hose (BrE)" },
            { word: "HOLIDAY", hint: "der Urlaub (BrE)" },
            { word: "DOLLAR", hint: "die US-Währung" },
            { word: "NICKNAME", hint: "der Spitzname" },
          ],
        },
      ],
    },
