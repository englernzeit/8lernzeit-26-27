...
export default {
  ...
  steps: [
    ...
    {
      step: 1,
      subtitle: "Mit „Help me“-Taste und Hilfe auf Deutsch",
      accent: "coral",
      layout: "slide",
      cards: [
        {
          ...
          intro: "Do you sometimes travel by train, bus or U-Bahn? Write one sentence: “Yes, I travel by …” or “No, I always go by …”.",
          answer: true,
        },
        {
          type: "tap-match",
    ...
    /* ================= STEP 2 — G-Kurs ================= */
    {
      ...
      cards: [
        ...
        },
        {
          type: "essay-editor",
          kind: "Finale",
          title: "Your own dialogue",
          intro: "A tourist from New York visits YOUR town and wants to use the bus, tram or U-Bahn. Write a dialogue of 8–10 lines. Start: “TOURIST: Excuse me, can you help me? I want to go to …”.",
          min: 50,
          max: 90,
          placeholder: "TOURIST: Excuse me, can you help me? …",
          chips: ["Which line …?", "How many stops …?", "How much does it cost?", "Where can I buy a ticket?", "You have to change at …", "Follow the signs."],
          checklist: ["8–10 lines?", "At least four useful phrases?", "A friendly ending?"],
        },
      ],
    },
    ...
    /* ================= STEP 3 — E-Kurs ================= */
    {
      ...
      cards: [
        ...
        },
        {
          ...
          audio: { src: A2, label: "🎧 Audio 2 — Emma asks for help (listen 2–3×)" },
          items: [
            { segments: ["EMMA: I want to go to Times Square, but I don't understand this ", { answer: "map", size: 8 }, "."] },
            { segments: ["MARCUS: You need the N or the Q train, and you have to go ", { answer: "uptown", size: 9 }, "."] },
            { segments: ["MARCUS: Uptown means ", { answer: "north", size: 8 }, ". Downtown means ", { answer: "south", size: 8 }, ". If you take the wrong direction, you end up in ", { answer: "Brooklyn", size: 10 }, "."] },
            { segments: ["EMMA: How do I pay? I don't have a ", { answer: "MetroCard", accept: ["Metro Card"], size: 11 }, "."] },
            { segments: ["MARCUS: Just ", { answer: "tap", size: 6 }, " your bank card or your phone at the gate. One ride costs ", { answer: "$2.90", accept: ["2.90", "two dollars ninety", "2 dollars 90"], size: 10 }, "."] },
            { segments: ["MARCUS: ", { answer: "Three", accept: ["3"], size: 7 }, " stops. Union Square, 23rd Street, 34th Street — and then Times Square."] },
            { segments: ["MARCUS: Careful! The express train ", { answer: "doesn't stop", accept: ["does not stop", "doesn’t stop"], size: 14 }, " at every station."] },
            { segments: ["EMMA: So the express is faster, but it ", { answer: "skips", size: 8 }, " the small stations."] },
            { segments: ["MARCUS: At the weekend there are often ", { answer: "service changes", accept: ["service change"], size: 16 }, "."] },
            { segments: ["MARCUS: But wait in the ", { answer: "middle", size: 8 }, " of the platform, and keep your phone in your ", { answer: "pocket", size: 8 }, "."] },
            { segments: ["MARCUS: Just follow the ", { answer: "green", size: 7 }, " signs. They say “Exit”."] },
          ],
        },
        {
          type: "written",
        ...
        },
        {
          ...
          intro: "Write a new dialogue (100–120 words). It is Saturday. A tourist wants to take the L train from Manhattan to Brooklyn — but you have just heard announcement 3. Your dialogue must contain the tourist's question, the bad news in your own words, a solution (which bus or train instead), one piece of practical advice, and a friendly ending.",
          min: 100,
          max: 120,
          placeholder: "TOURIST: Excuse me, I want to take the L train to Brooklyn …",
          chips: ["the tourist's question", "the bad news (own words)", "a solution", "practical advice", "a friendly ending"],
          checklist: ["All five points?", "The bad news in your own words?", "Would the tourist really find the way?", "100–120 words?"],
        },
      ],
    },
