      ...
      cards: [
        {
          ...
          blanks: [
            { key: "name", label: "A name", placeholder: "Mia, Leo, or your own name" },
            { key: "place", label: "A place", placeholder: "Central Park, Times Square…" },
            { key: "past", label: "Yesterday you… (a past verb)", placeholder: "found, met, saw, lost…" },
            { key: "creature", label: "A funny animal or thing", placeholder: "pigeon, robot, hot dog…" },
            { key: "ing", label: "…doing it right now (verb + -ing)", placeholder: "dancing, singing, jumping…", ing: true },
            { key: "present", label: "Something you do every day (verb)", placeholder: "eat, play, dance, laugh…" },
            { key: "food", label: "A food", placeholder: "pizza, bagels, ice cream…" },
          ],
          help: "★ Bonus: read your finished story out loud to a partner — can they hear the three tenses (yesterday · right now · every day)?",
        },
      ],
    },
  ],
