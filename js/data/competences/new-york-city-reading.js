    ...
    courses: [
      {
        ...
        // New contexts — never the same sentence as the picture card, so the
        // drill tests the word, not memory of one example.
        items: [
          { de: "Texas ist ein großer (Bundes-)Staat im Süden der USA.", en: "Texas is a big ___ in the south of the USA.", answer: "state" },
          { de: "Mit 18 Jahren (in diesem Alter) darf man wählen.", en: "You can vote at the ___ of 18.", answer: "age" },
          { de: "Nach dem Krieg feierten die Menschen ihre Freiheit.", en: "After the war, the people celebrated their ___.", answer: "liberty" },
          { de: "Manhattan ist eigentlich eine Insel zwischen zwei Flüssen.", en: "Manhattan is actually an ___ between two rivers.", answer: "island" },
          { de: "Der Times Square ist eine Sehenswürdigkeit, die jeder besuchen will.", en: "Times Square is a ___ that everyone wants to visit.", answer: "sight" },
          { de: "Das Konzert gestern Abend war einfach großartig!", en: "The concert last night was simply ___!", answer: "awesome" },
          { de: "Ein Feuer kann in wenigen Minuten ein Haus zerstören.", en: "A fire can ___ a house in a few minutes.", answer: "destroy" },
          { de: "Wir wohnen seit 2012 in dieser Stadt.", en: "We have lived in this city ___.", answer: "since 2012", accept: ["since twenty twelve"] },
          { de: "Vom Dach hat man einen schönen Ausblick auf den Park.", en: "From the roof you have a lovely ___ of the park.", answer: "view" },
          { de: "Ein schmaler Fußweg führt hinunter zum Fluss.", en: "A narrow ___ leads down to the river.", answer: "walkway" },
          { de: "Ihr Zimmer liegt direkt über meinem.", en: "Her room is right ___ mine.", answer: "above" },
          { de: "Am Morgen ist der Verkehr besonders schlimm.", en: "In the morning the ___ is especially bad.", answer: "traffic" },
          { de: "Mein Opa hat dieses Haus vor 40 Jahren gebaut.", en: "My grandpa ___ this house 40 years ago.", answer: "built", accept: ["build"] },
          { de: "Der kleine Junge malte einen gelben Stern.", en: "The little boy drew a yellow ___.", answer: "star" },
          { de: "Als Einwanderer lernte er schnell die neue Sprache.", en: "As an ___, he learned the new language quickly.", answer: "immigrant" },
        ],
      },
      {
        key: "ek",
        ...
        tag: "Statue of Liberty & the city",
        subtitle: "Read the German sentence, then complete the English one.",
        // New contexts — never the same sentence as the picture card.
        items: [
          { de: "Die Königin trägt bei der Zeremonie eine goldene Krone.", en: "The queen wears a golden ___ at the ceremony.", answer: "crown" },
          { de: "Dieser Hafen war das Tor zur Neuen Welt.", en: "This harbour was the ___ to the New World.", answer: "gateway" },
          { de: "Die Einwanderung veränderte das Land für immer.", en: "___ changed the country forever.", answer: "immigration" },
          { de: "Möchtest du ein Stück Kuchen?", en: "Would you like a ___ of cake?", answer: "piece" },
          { de: "Ein langer Tunnel verbindet die beiden Ufer.", en: "A long tunnel ___ the two banks of the river.", answer: "connects", accept: ["connect"] },
          { de: "Die Golden Gate Bridge ist eine riesige Hängebrücke.", en: "The Golden Gate Bridge is a huge ___.", answer: "suspension bridge", accept: ["suspension-bridge"] },
          { de: "Vor 200 Jahren mussten viele Sklaven auf den Feldern arbeiten.", en: "200 years ago, many ___ had to work in the fields.", answer: "slaves", accept: ["slave"] },
          { de: "Queens ist der größte (Stadt-)Bezirk der Stadt.", en: "Queens is the largest ___ in the city.", answer: "borough", accept: ["boroughs"] },
          { de: "Millionen Menschen bevölkern diese dicht besiedelte Insel.", en: "Millions of people ___ this crowded island.", answer: "populate" },
          { de: "Während des Krieges verließen viele Familien ihre Heimat.", en: "During the ___, many families left their home.", answer: "war" },
          { de: "Die USA feiern ihre Unabhängigkeit am 4. Juli.", en: "The USA celebrate their ___ on the 4th of July.", answer: "independence" },
          { de: "Sie hängte einen leuchtenden Stern an den Weihnachtsbaum.", en: "She hung a shining ___ on the Christmas tree.", answer: "star" },
          { de: "Der neue Film war wirklich großartig.", en: "The new film was really ___.", answer: "awesome" },
          { de: "Vom Wolkenkratzer aus sieht man die ganze Stadt.", en: "From the ___ you can see the whole city.", answer: "skyscraper" },
          { de: "Nach der Schule spielen wir Fußball im Park.", en: "After school we play ___ in the park.", answer: "soccer" },
        ],
      },
    ],
  },
