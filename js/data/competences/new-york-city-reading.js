    ...
    /* ================= STEP 3 — E-Kurs ================= */
    {
      ...
      cards: [
        ...
        },
        {
          ...
          lineNumbers: true,
          paraStarts: [1, 7, 15, 21],
          paragraphs: [
            ["When people think of New York City, they imagine skyscrapers,"],
            ["yellow taxis and crowded sidewalks. But between the cars and buses,"],
            ["there is another group that keeps the city moving: bike messengers."],
            ["For more than a hundred years, these cyclists have carried letters,"],
            [
              { w: "contracts", de: "contract = a legal document" },
              ", film reels and packages across Manhattan — often faster",
            ],
            ["than any car could."],
            ["The golden age of the bike messenger was the 1980s and 1990s."],
            ["Before e-mail existed, banks and law firms needed original documents"],
            ["delivered within the hour, and thousands of messengers raced through"],
            ...
            [
              ...
              " completely. They were wrong.",
            ],
            ["Digital files replaced paper, but online shopping and food delivery"],
            ["apps created new work. Today's messengers deliver everything from"],
            ["sushi to laptop computers."],
            [
              "It remains one of the ",
              { w: "toughest", de: "tough = very hard and difficult" },
              " jobs in the city. Messengers ride up",
            ],
            ["to 80 kilometres a day, in burning summer heat and icy winter winds."],
            ["Car doors open suddenly, taxis change lanes without warning, and"],
            [
              "accidents are common. Most messengers are paid ",
              { w: "per delivery", de: "for each package they bring" },
              ", not per",
            ],
            ["hour — so speed means money, and waiting at a red light can feel like"],
            ["losing a dollar."],
            ["Yet many messengers would never change their job. They describe a"],
            ["feeling of freedom that no office can offer, and they belong to a proud"],
            [
            ...
            [
              ...
              " messenger put it: “In an",
            ],
            ["office you watch the city through a window. On my bike, I am part of it.”"],
          ],
        },
        {
          type: "tap-match",
        ...
        },
        {
          type: "match-up",
          kind: "Beweise",
          title: "Find the evidence — which lines?",
          intro: "The text supports each statement. In which lines is the proof? Use the line numbers.",
          options: ["Zeile 1–6", "Zeile 7–14", "Zeile 15–20", "Zeile 21–25"],
          items: [
            { left: "The job is physically dangerous.", answer: "Zeile 15–20" },
            { left: "Bike messengers have their own identity and traditions.", answer: "Zeile 21–25" },
            { left: "The profession is older than most people think.", answer: "Zeile 1–6" },
          ],
        },
        {
          type: "written",
        ...
        },
        {
          ...
          starters: [
            "“keeps the city moving” (line 3) means …",
            "“the golden age” (line 7) means …",
            "“On my bike, I am part of it.” (line 25) means …",
          ],
        },
        {
          type: "essay-editor",
